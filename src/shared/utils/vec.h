...
static inline vec2_t vec2_i16(int16_t x, int16_t y) {
  return (vec2 _t){.x = x, .y = y};
}
static inline vec2_t vec2_i16_zero(void) { return (vec2_t){.x = 0, .y = 0}; }
static inline vec2_t vec2_i16_add(vec2_t a, vec2_t b) {
