...
export function TableHead({ className, ...props }: React.ComponentProps<"th">) { return <th className={cn("h-10 px-2 text-left align-middle font-mono font-medium text-muted-foreground", className)} {...props} />; }
